...
priors_duration = #prior(student_t(3,2,8), class = Intercept, resp = 'DurationInSeconds'),
   c(
    #prior(student_t(3,2,2.5), class = Intercept, resp = 'DurationInSeconds'), ## new!
     ...
     prior(normal(-0.25, 0.5), class = b, coef = 'nTrialLevelScale', resp = 'DurationInSeconds'),
     ...
     prior(normal(0,0.25), class = sd, coef = 'nTrialLevelScale', group = 'SubjectCode', resp = 'DurationInSeconds'),
     prior(normal(0,0.25), class = sd, coef = 'nTrialLevelScale', group = 'Level', resp = 'DurationInSeconds')
