...
ModelA =  brm (
  ...
  iter = 1800,
  seed = 8,
  file = '../results/ModelA_variable_shiftperLevel_20210317',
  sample_file = '../results/ModelArtchaindata_shiftsigma_20210317',
