...
priors_duration = #prior(student_t(3,2,8), class = Intercept, resp = 'DurationInSeconds'),
  c(
    ...
    prior(normal(0.5,0.5), class = Intercept, dpar = 'shift'),
    prior(normal(0,0.5), class = sd, dpar = 'shift', group = 'SubjectCode'),
    
    #prior(student_t(3, -0.5, 1.5), class = b, coef = 'nTrialLevelScale', resp = 'DurationInSeconds'),
    prior(normal(-0.25, 0.5), class = b, coef = 'nTrialScaled'),# resp = 'DurationInSeconds'),
    ...
    prior(normal(0,0.25), class = sd, coef = 'nTrialScaled', group = 'SubjectCode')# resp = 'DurationInSeconds')
    #prior(normal(0,0.25), class = sd, coef = 'nTrialScaled', group = 'Level')#, resp = 'DurationInSeconds')
...
ModelA =  brm (
  ...
  iter = 1800,
  seed = 4,
  file = '../results/ModelA_variable_shift_20210314',
